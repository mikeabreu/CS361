...
public class LoginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if ((boolean) auth[0]) {
            userid = (int) auth[1];
            out.println(
                    "<html><body>Successful login! If you aren't redirected shortly click <a href='/account'>here</a></body></html>");
            ...
            response.setHeader("Refresh", "5; URL=/account");
        } else {
            out.println(
                    "<html><body>Login Attempt Failed! If you aren't redirected shortly click <a href='/'>here</a></body></html>");
